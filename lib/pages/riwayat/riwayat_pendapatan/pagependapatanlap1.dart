...
class RiwayatPendapatanLapangan1 extends StatelessWidget {
  const RiwayatPendapatanLapangan1({Key? key}) : super(key: key);
          ...
          Row(
            children: [
              Expanded(
                child: MyButton(
                  text: 'Pendapatan',
                  onPressed: () {Get.toNamed(AppRoutes.pendapatanlap1);},
