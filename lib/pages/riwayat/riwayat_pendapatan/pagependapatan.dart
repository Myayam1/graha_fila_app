              ...
              children: [
                ...
                Obx(() => IconButton(
                  icon: Icon(
                    ...
                    color: controller.selectedDate.value != null ? Colors.green : Mycolors.blue,
                  ),
                  onPressed: () async {
                ...
                Obx(() => IconButton(
                  icon: Icon(
                    Icons.filter_list,
                    color: controller.selectedLapangan.value != null ? Colors.green : Mycolors.blue,
                  ),
                  onPressed: () {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return RiwayatPendapatanCard(
                          nominal: payment.amount?.replaceAll('"', '') ?? '0',
                          tanggal: controller.formatDate(payment.createdAt),
                          nama: payment.name ?? '-',
