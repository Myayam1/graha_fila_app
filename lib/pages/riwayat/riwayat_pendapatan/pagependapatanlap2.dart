...
class RiwayatPendapatanLapangan2 extends StatelessWidget {
  const RiwayatPendapatanLapangan2({Key? key}) : super(key: key);
          ...
          Row(
            children: [
              Expanded(
                child: MyButton(
                  text: 'Pendapatan',
                  onPressed: () {Get.toNamed(AppRoutes.pendapatanlap2);},
